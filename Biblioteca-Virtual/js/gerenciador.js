class Gerenciador {
  ...
  initEventos() {
    document
      ...
      .addEventListener("input", () => this.mostrarLivros());
    document
      .getElementById("filtro-genero")
      .addEventListener("change", () => this.mostrarLivros());

    document.getElementById("alternar-tema").addEventListener("click", () => {
      document.body.classList.toggle("modo-escuro");
      this.atualizarBotaoTema();
    });
  }
    ...
    return `
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <button class="btn btn-success mt-auto" onclick="gerenciador.adicionarLivro(${livro.id})">
...
renderizarListaLidos() {
  ...
  alternarStatusLeitura(indice) {
    ...
    if (sucesso) {
      ...
      console.error(
        "Falha ao alternar status de leitura para o índice:",
        indice
      );
    }
  }
